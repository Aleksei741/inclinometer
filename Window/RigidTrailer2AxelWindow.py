...
class RigidTrailer2AxelWindow(CarFrame):
    def __init__(self, master, vehicle_data: VehicleAlignmentData):
        ...
        self.creatTableFixedWheelParams(main_frame, 0, "left").grid(row=2, column=0, padx=5) 
        
        # ----------- Таблицы параметров правого фиксированного колеса 1 ----------
        self.creatTableFixedWheelParams(main_frame, 0, "right").grid(row=2, column=2, padx=5)
